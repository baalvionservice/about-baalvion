      ...
      <main className="flex-1">
            ...
            <div className="section-container relative z-10 animate-fade-in">
              <div className="max-w-4xl">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 mb-16">
                  <Button size="lg" asChild className="h-14 px-10 btn-primary w-full sm:w-auto text-base">
                    <Link href="/platform" className="flex items-center">{heroSection.data.ctaPrimary} <ArrowRight className="ml-2 w-4 h-4" /></Link>
                  </Button>
                  <Button size="lg" variant="outline" asChild className="h-14 px-10 btn-outline w-full sm:w-auto text-base">
            ...
            <div className="section-container">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {problemSection.data.points.map((point: any, i: number) => (
                  <Card key={i} className="bg-white p-8 shadow-sm border border-gray-100 rounded-xl">
          ...
          <section className="section-vertical-padding bg-white border-b border-gray-100">
            <div className="section-container">
              <div className="grid lg:grid-cols-2 gap-24 items-center">
                ...
                <div className="bg-gray-50 rounded-2xl p-12 lg:p-16 text-center space-y-8 border border-gray-100">
                  ...
                  <Button asChild className="w-full h-12 btn-primary rounded-lg font-bold">
          ...
          <div className="section-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {ecoItems.slice(0, 4).map((item, i) => (
                <Card key={item.id} className="bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all rounded-xl h-full group">
                  <div className="p-8 space-y-6 flex flex-col h-full">
                    <div className="w-12 h-12 bg-primary/5 rounded-lg flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-all">
          ...
          <div className="section-container">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {projects.slice(0, 3).map((project) => (
                <Card key={project.id} className="bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all rounded-xl group">
                  <CardContent className="p-8 space-y-6">
                    <div className="flex justify-between items-start">
                      <div className="w-10 h-10 bg-gray-50 rounded-lg flex items-center justify-center text-primary group-hover:bg-primary/10 transition-colors">
        ...
        {ctaSection && (
          <section className="section-vertical-padding bg-gray-50">
            <div className="section-container">
              <div className="bg-white p-12 md:p-20 text-center rounded-2xl shadow-sm border border-gray-100 max-w-5xl mx-auto">
