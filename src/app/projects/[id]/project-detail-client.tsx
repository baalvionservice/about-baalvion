...
export default function ProjectDetailClient({ id }: { id: string }) {
  ...
  if (!project) return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center text-center p-8">
      <h1 className="text-4xl font-bold mb-4 text-white">404: Node Missing</h1>
              ...
              <section className="grid md:grid-cols-2 gap-12 animate-fade-in">
                <Card className="glass-card border-white/5 p-12 space-y-8">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-2xl font-bold text-white">Ecosystem Role</h3>
          ...
          {related.length > 0 && (
            <section className="mt-48 space-y-16 animate-fade-in">
              <div className="flex items-center gap-6">
                ...
                <h2 className="text-3xl font-bold mb-0 text-white">Related {project.category} Nodes</h2>
              </div>
