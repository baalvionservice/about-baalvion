          ...
          <div className="grid lg:grid-cols-2 gap-32 items-center">
            <div className="space-y-16">
              <div className="space-y-6">
                ...
                <h2 className="text-white">Adhering to the world's strictest protocols.</h2>
              </div>
            ...
            <div className="glass-card p-20 rounded-[4rem] border-primary/20 bg-primary/5 text-center space-y-12">
              ...
              <h3 className="text-2xl font-bold text-white">Security & Compliance Documentation</h3>
              <p className="text-xl mx-auto text-muted-foreground">
