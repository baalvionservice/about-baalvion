...
/**
 * Server-side rendered company page component
 * Optimized for SEO and Google indexing
 */
export default function CompanyPageServer() {
  return (
    <main>
        ...
        <div className="space-y-32">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <p className="text-2xl md:text-3xl text-gray-800 leading-relaxed font-light">
              We are architecting the foundational layer for the next century of
              international commerce, bridging the gap between legacy systems
