  ...
  return (
    <nav className={cn(
      ...
      <div className="section-container h-full flex items-center justify-between">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-3 group shrink-0 relative z-[110]">
      ...
      <div className={cn(
        ...
        <form onSubmit={handleSearch} className="relative">
          ...
          />
          <button type="submit" className="absolute right-4 top-1/2 -translate-y-1/2 text-primary p-2">
            <Search className="w-6 h-6" />
          </button>
        </form>
      </div>
      ...
      <div className={cn(
        ...
        <div className="flex-1 overflow-y-auto pt-24 pb-32 px-6">
          ...
          <div className="mt-8 pt-8 border-t border-gray-100 space-y-4">
            <button className="w-full flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:border-primary/20 transition-all group">
              ...
              <span className="text-[10px] font-bold text-primary uppercase tracking-widest bg-primary/5 px-2 py-1 rounded">Weekly</span>
            </button>
          </div>
        </div>
